...
export default {
  ...
  methods: {
    ...
    login () {
      ...
      const userSig = "eJwtzE0LgkAUheH-MtvCrte5kkKblIg*FjFRCG0CJ7tIoTOWA9F-z9TleV44H3HcKe*tjYgFeiCm-eZcPxu*cc8vqw3iWGxeXquKcxH7EkBiQFIORbuKje6ciBAABm348bdQEvh*gKNaLrpjd3CYqFRl84C2bTiJ2vLUnk1tNjUtL7N7tOI9ra3M0qRYiO8PXloxIw__";
      const sdkAppID = 1400423544
      const userID = "user22"
    ...
    //   console.log(window.genTestUserSig(this.form.userID).userSig)
